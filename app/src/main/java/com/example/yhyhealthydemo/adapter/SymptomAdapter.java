...
public class SymptomAdapter extends BaseAdapter {
    ...
    public SymptomAdapter(Context mContext) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        SymptomAdapter.ViewHolder holder = null;
        if (view == null) {
            holder = new SymptomAdapter.ViewHolder();
            ...
            holder = (SymptomAdapter.ViewHolder) view.getTag();
        }
